        ...
        <div className="footer sm:footer-horizontal text-base-content px-6 md:px-10 md:pt-30 pt-10">
          ...
          <nav>
            ...
            <div className="flex gap-4">
              <Link
                to={"https://www.facebook.com/m.ismail.hossain24/"}
                target="_blank"
              ...
              <Link
                to={"https://github.com/ismail-dev-code"}
                target="_blank"
                className="link link-hover"
              >
                <FaGithub size={25} />
              ...
              <Link
                to={"https://www.instagram.com/m.ismailhossain24/"}
                target="_blank"
                className="link link-hover"
              >
                <FaInstagram size={25} />
              ...
              <Link
                to={"https://ismail-web-developer.netlify.app/"}
                target="_blank"
                className="link link-hover"
              >
                <CgWebsite size={25} />
